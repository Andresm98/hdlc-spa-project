  ...
  <app-layout>
    ...
    >
      ...
      >
        ...
        >
          ...
          <p
            ...
            "
          >
            Información General de los permisos realizados en la Compañía
          </p>
        </div>
        <div
          class="
      ...
      <div class="content-center mt-2">
        <jet-button-success
          @click="confirmationPermitCreate()"
          class="block mx-5 leading-normal"
          >¿Desea crear un nuevo permiso?</jet-button-success
        >
      </div>
    </section>
                      ...
                      <template #dropdown>
                        ...
                        >
                          <a
                            ...
                            target="_blank"
                            :href="
                              route('secretary.permissions.pdf', this.params)
                            "
                            >PDF</a
                          >
                          <a
                            ...
                            :href="
                              route(
                                'secretary.permissions.export.excel',
                                this.params
                              )
                            "
                            >Excel</a
                          ...
                          <a
                            ...
                            :href="
                              route(
                                'secretary.permissions.export.csv',
                                this.params
                              )
                            "
                            >CSV</a
                  ...
                  >
                    <table class="min-w-full divide-y divide-gray-200">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        <tr v-for="permit in this.permits.data" :key="permit">
                            ...
                            <div class="flex items-center">
                                ...
                                <a
                                  :href="
                                    route('secretary.daughters.edit', {
                                      slug: permit.profile.user.slug,
                                    })
                                  "
                                >
                                  <img
                                    class="h-10 w-10 rounded-full"
                                    :src="permit.profile.user.profile_photo_url"
                                    alt=""
                                  />
                                </a>
                              </div>
                              <div class="ml-4">
                                <div class="text-sm font-medium text-gray-900">
                                  {{ permit.profile.user.name }}
                                </div>
                                <div class="text-sm text-gray-500">
                                  {{ permit.profile.user.lastname }}
                                </div>
                                <span
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="w-6/8 ...">
                              ...
                              <span
                                ...
                                "
                              >
                                <div v-if="permit.community != null">
                          ...
                          >
                            ...
                            <div class="mx-auto flex gap-10">
                              ...
                              <button @click="confirmationPermitDelete(permit)">
                                <div class="w-auto h-auto">
                                  <div class="flex-1 h-full">
                                    <div
                                      class="
    ...
    <jet-dialog-modal
      :max-width="'input-md'"
      :show="permitBeingCreated"
      @close="permitBeingCreated == null"
    >
      <template #title> Datos del Nuevo Permiso</template>
        ...
        <div class="flex flex-wrap">
          ...
          <div class="w-full lg:w-12/12 px-4">
            <div class="">
              ...
              <p
                class="text-red-400 text-sm"
                v-show="$page.props.errors.reason"
              >
          ...
          <div class="w-full lg:w-6/12 px-4">
            <div class="relative w-full mb-3">
              ...
              <p
                class="text-red-400 text-sm"
                v-show="$page.props.errors.date_province"
              >
          ...
          <div class="w-full lg:w-6/12 px-4">
            <div class="relative w-full mb-3">
              ...
              <p
                class="text-red-400 text-sm"
                v-show="$page.props.errors.date_general"
              >
          ...
          <div class="w-full lg:w-6/12 px-4">
            <div class="relative w-full mb-3">
              ...
              <p
                class="text-red-400 text-sm"
                v-show="$page.props.errors.date_out"
              >
          ...
          <div class="w-full lg:w-6/12 px-4">
            <div class="relative w-full mb-3">
              ...
              <p
                class="text-red-400 text-sm"
                v-show="$page.props.errors.date_in"
              >
          ...
          <div class="w-full lg:w-2/5 px-4 mb-2">
            <div class="w-full">
              ...
              <div :class="{ invalid: isInvalid }">
                ...
                <p class="text-red-400 text-sm" v-show="isInvalid">
                  Obligatorio
                </p>
              </div>
            </div>
  ...
  watch: {
    ...
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("secretary.permissions.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
    ...
    deletePermit() {
      this.deletePermitForm.delete(
        this.route("secretary.daughter-profile.permit.delete", {
          user_id: this.permitBeingDeleted.profile.user_id,
        ...
        }),
        {
          ...
          preserveState: true,
          onSuccess: () => (
            (this.permitBeingDeleted = null), setTimeout(() => {}, 500)
          ),
        }
      );
    },
