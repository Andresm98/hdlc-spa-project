        ...
        <div class="px-4 py-5 bg-white sm:p-6">
          <div class="w-full lg:w-12/12 px-4 mb-2">
            <div class="relative w-full">
              ...
              <div :class="{ invalid: isInvalidPerfil }">
                <multiselect
                  :searchable="true"
                  v-model="selectCyx.selectedCommunity"
          ...
          <div>
            <small
              ...
              de cada cada comunidad u obra, por ejemplo puede guardar PDFs que
              contengan información relacionada a los trámites que se realizan
              en cada comunidad.
              <br />
      ...
      <template #footer>
        <jet-secondary-button
          @click="
            ...
            form = null;
            selectCyx.options = [];
            selectCyx.selectedCommunity = null;
          "
        >
          Cancelar
        </jet-secondary-button>
  ...
  watch: {
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(
          this.route("secretary.filesglobal.communities.index"),
          params,
          {
            replace: true,
            preserveState: true,
  ...
  methods: {
      ...
      if (this.isInvalidPerfil == false) {
        this.form.post(
          route(`secretary.communities.files.store`, {
            community_id: this.selectCyx.selectedCommunity.id,
          }),
          {
            preserveScroll: true,
            onSuccess: () => {
    ...
    onSearchCommunityChange(search) {
      ...
      if (search != null) {
        axios
          .get(
            this.route("secretary.filesglobal.communities.search", {
              search: search,
            })
          )
          .then((response) => {
