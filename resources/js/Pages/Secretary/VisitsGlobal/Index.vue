<template>
  <app-layout>
    ...
    >
      ...
      <div class="content-center mt-2">
        <jet-button-success
          ...
          >¿Desea crear una nueva visita?</jet-button-success
        >
      </div>
    </section>
                      ...
                      <template #dropdown>
                        ...
                        >
                          <a
                            ...
                            :href="
                              route(
                                'secretary.visits.communities.pdf',
                                this.params
                              )
                            "
                            >PDF</a
                          ...
                          <a
                            ...
                            :href="
                              route(
                                'secretary.visits.communities.export.excel',
                                this.params
                              )
                            "
                            >Excel</a
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="flex items-center">
                              <div
                                ...
                                v-if="visit.community.comm_level === 1"
                              >
                                <svg
                              ...
                              <div
                                class="flex-shrink-0 h-10 w-10"
                                v-if="visit.community.comm_level === 2"
                              >
                                <svg
                                  class="svg-icon border-2 rounded-full"
                                  viewBox="-2.5 -1 25 25"
                              ...
                              <div class="ml-4 w-6/8 ...">
                                ...
                                >
                                  ...
                                  <div v-if="visit.comm_type_visit == 2">
                                    Regular
                                  </div>
                                  <div v-if="visit.comm_type_visit == 3">
                                    Pastoral
                                  </div>
                                </span>
                                <div
                                ...
                                >
                                  {{
                                    visit.comm_reason_visit.substring(0, 60)
                                  }}..
                                </div>
                              </div>
                            </div>
                          ...
                          <td class="px-6 py-4 whitespace-nowrap">
                            <div class="ml-4 w-full...">
                              ...
                              >
                                <p
                                  v-html="
                                    visit.comm_description_visit.substring(
                                      0,
                                      30
                                    )
                                  "
    ...
    >
      <template #title> Datos de la Nueva Visita</template>
  ...
  watch: {
    ...
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("secretary.visits.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
  ...
  methods: {
    onSearchCommunityChange(search) {
      ...
      if (search != null) {
        axios
          .get(
            this.route("secretary.visits.communities.index", {
              search: search,
            })
          )
          .then((response) => {
