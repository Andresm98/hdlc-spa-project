  ...
  <app-layout>
    ...
    <div>
                  ...
                  <tbody class="bg-white divide-y divide-gray-200">
                    <tr v-for="pastoral in pastorals" :key="pastoral">
                        ...
                        >
                          <div v-for="comm in groupCommunities" :key="comm">
                            <div v-if="comm.pastoral_id == pastoral.id">
                              <a
                                :href="
                                  'all?active=1&type=1&pastoral=' + pastoral.id
                                "
                        ...
                        >
                          <div v-for="works in groupWorks" :key="works">
                            <div v-if="works.pastoral_id == pastoral.id">
                              <a
                                :href="
                                  'all?active=1&type=2&pastoral=' + pastoral.id
                                "
                                class="hover:cursor-pointer"
                              >
                                {{ works.total }}
                      ...
                      <td class="px-6 whitespace-nowrap">
                        ...
                        >
                          <div
                            v-for="daughters in groupDaughters"
                            :key="daughters"
                          >
      ...
      <div
        class="
          pb-6
          lg:grid lg:grid-cols-3 lg:gap-3 lg:mx-12 lg:mb-6
          h-1/2
          w-6/6
        "
      >
