  ...
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-700 leading-tight">
        Secretaría, Editar articulos de la Sección
      </h2>
    ...
    <operation></operation>
    <section
      class="bg-gray-200 dark:bg-slate-800 y-1 px-4 sm:p-6 md:py-10 md:px-8 pt-2 pb-4 rounded-lg m-2"
    >
      <div
  ...
  methods: {
    ...
    updateArticle() {
      this.updateArticleForm.put(
        this.route("secretary.communities.articles.update", {
          section_slug: this.section_slug,
