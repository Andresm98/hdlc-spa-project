<template>
  ...
  > -->
      <div v-if="this.newPaginateData != null">
        <div class="flex flex-col items-center justify-center bg-center bg-cover">
                          ...
                          <div class="flex items-center">
                            <div class="flex flex-col">
                              ...
                              <div class="flex-auto text-gray-500 my-1">
                                <span class="mr-3">{{ work_ob.comm_email }}</span>
                                <span
      ...
      <!-- Delete  Data Form-->
      <jet-confirmation-modal :show="workBeingDeleted" @close="workBeingDeleted == null">
    ...
    allWorks() {
      axios
        ...
        .then((res) => {
          ...
          //   console.log("One: \n", this.newPaginateData);
          //   this.newPaginateData = this.newPaginateData.links;
          //   console.log("Two: \n ", this.newPaginateData);
        });
    },
  },
