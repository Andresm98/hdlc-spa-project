  ...
  <app-layout>
            ...
            <ul class="list-disc pl-5">
              <li class="dark:text-white">
                <p class="mt-2 pt-6 text-sm uppercase">
                  Nombre de obra único en el sistema.
                </p>
              </li>
              <li class="dark:text-white">
    ...
    <section class="py-1 bg-slate-800 rounded-lg m-1">
      <div class="w-full lg:w-5/6 px-4 mx-auto mt-6">
        ...
        >
          <div class="bg-slate-200 hover:bg-slate-200 rounded-lg">
            <form @submit.prevent="submit" class="">
              <div class="rounded-t bg-white mb-0 px-6 py-6">
                <div class="text-center flex justify-between">
                  <h6 class="text-sm font-medium leading-6 text-gray-900">
                    Tarjeta de Información General de la Obra, que será asignada
                    a la comunidad:
                        ...
                        <a
                          :href="
                            route('secretary.communities.edit', {
                              slug: this.community_custom.comm_slug,
                            })
                          "
                        >
                          {{ this.community_custom.comm_name }}
                        </a>
                      </span>
                    </h5>
                  </h6>
              ...
              <div class="flex flex-wrap">
                <div class="w-full lg:w-3/3 px-4">
                  <div class="relative w-full mb-3">
                    ...
                    <small>Formato: Ingresar el nombre de la obra.</small>
              ...
              <div class="flex flex-wrap">
                <div class="w-full lg:w-6/12 px-4">
                  ...
                  <small>Formato: Ingresar un correo de contacto.</small>
                  <input
                    type="email"
...
export default {
  ...
  methods: {
    ...
    async status() {
      this.form.address = this.community_custom.id.address["address"];
      this.form.political_division_id =
        this.community_custom.id.address["political_division_id"];
