  ...
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-700 leading-tight">
        Listado de los Vehículos a las Comunidades u Obras
      </h2>
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Información General de los vehículos registrados en las comunidades
            u obras.
          </p>
        </div>
        <div
        ...
        >
          ...
          >
            ...
            <div class="container mx-auto ml-7">
                      ...
                      <template #dropdown>
                        ...
                        >
                          <a
                            ...
                            :href="
                              route(
                                'secretary.vehicles.communities.export.excel',
                                this.params
                              )
                            "
                            >Excel</a
              ...
              <small class="ml-6">
                Se encontraron {{ visits.total }} vehículos.</small
              >
              <div class="py-2">
    ...
    >
      <template #title> Datos del nuevo Vehículo</template>
            ...
            <div class="relative w-full mb-3">
              <div class="">
                ...
                <input
                  ...
                  minLength="10"
                  maxlength="100"
                  placeholder="Ingresar el tipo del Vehículo"
                  class="border-0 px-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  v-model="form.type"
                  required
                />
            ...
            <div class="relative w-full mb-3">
              <div class="">
                ...
                <input
                  ...
                  minLength="10"
                  maxlength="100"
                  placeholder="Ingresar el color del Vehículo"
                  class="border-0 px-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                  v-model="form.color"
                  required
                />
            ...
            <div class="relative w-full mb-3">
              <div class="">
                ...
                <input
                  ...
                  minLength="10"
                  maxlength="100"
                  placeholder="Ingresar tipo del Vehículo"
                  class="border-0 px-3 placeholder-blueGray-300 text-blueGray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
  ...
  watch: {
    ...
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("secretary.vehicles.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {},
  ...
  methods: {
    onSearchCommunityChange(search) {
      ...
      if (search != null) {
        axios
          .get(
            this.route("secretary.vehicles.communities.index", {
              search: search,
            })
          )
          .then((response) => {
