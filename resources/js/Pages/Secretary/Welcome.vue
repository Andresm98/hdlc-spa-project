      ...
      <div class="flex flex-col md:flex-row">
        <section>
          ...
          >
            ...
            <h1 class="m-6 font-bold uppercase">Datos Secretaría</h1>
                  ...
                  <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                      <h2 class="font-bold uppercase text-gray-600">
                        Número Total de Hermanas Activas
                      </h2>
                ...
                >
                  <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                      ...
                      <p class="font-bold text-3xl">{{ activepermits }}</p>
                    </div>
                  </div>
                </div>
                <!--/Metric Card-->
          ...
          <hr class="mx-4" />
          <h1 class="m-6 font-bold uppercase">Datos Históricos</h1>
          <!--
              ...
              <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                >
                  <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                      <h2 class="font-bold uppercase text-gray-600">
                        Número Total de Hermanas Fallecidas
                      </h2>
                      <p class="font-bold text-3xl">
                        {{ dthdaughters }}
                        <span class="text-yellow-600"
              ...
              <div class="w-full md:w-1/2 xl:w-1/3 p-6">
                ...
                >
                  <div class="flex flex-row items-center">
                    ...
                    <div class="flex-1 text-right md:text-center">
                      <h2 class="font-bold uppercase text-gray-600">
                        Número Total de Hermanas Retiradas
                      </h2>
                      <p class="font-bold text-3xl">{{ rtrdaughters }}</p>
                    </div>
                  </div>
                </div>
                <!--/Metric Card-->
