  ...
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl text-gray-700 leading-tight">
        Listado de Inventario por Comunidades
      </h2>
      ...
      <div class="w-full lg:w-full">
        ...
        >
          ...
          >
            ...
            <small class="ml-6">
              Se encontraron {{ communities_list.total }} inventarios.</small
            >
            <div class="py-2">
                      ...
                      <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        >
                          ...
                          >
                            <Link
                              :href="
                                route('secretary.communitiesglobal.inventorie.index', {
                                  community_id: community_custom.id,
                                })
                              "
                            >
  ...
  watch: {
    ...
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("secretary.communitiesglobal.inventories.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
        });
