<template>
  <app-layout>
                      ...
                      <template #dropdown>
                        ...
                        >
                          <a
                            ...
                            :href="
                              route(
                                'secretary.activities.communities.pdf',
                                this.params
                              )
                            "
                            >PDF</a
                          ...
                          <a
                            ...
                            :href="
                              route(
                                'secretary.activities.communities.export.excel',
                                this.params
                              )
                            "
                            >Excel</a
    ...
    >
      <template #title> Datos de la Nueva Actividad</template>
  ...
  watch: {
    ...
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("secretary.activities.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {
  ...
  methods: {
    ...
    onSearchCommunityChange(search) {
      ...
      if (search != null) {
        axios
          .get(
            this.route("secretary.activities.communities.index", {
              search: search,
            })
          )
          .then((response) => {
