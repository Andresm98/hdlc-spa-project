  ...
  watch: {
    ...
    "createDocumentForm.type": function () {
      ...
      if (this.createDocumentForm.type === 1) {
        ...
        this.createDocumentForm.content = `<p><strong>Sor&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Fecha de Emisión: </strong></p><p class="ql-align-justify"><strong>Autorización:</strong></p><p class="ql-align-justify"><strong>Lugar:</strong></p><p class="ql-align-justify"><strong>Tiempo</strong>:</p><p class="ql-align-justify"><strong>Días</strong>:</p><p class="ql-align-justify"><strong>Observación: </strong>Visitará a su Mamá delicada de salud, la (…………..) Ruego mantener la flexibilidad pertinente ante los requerimientos de la Comunidad local; salvo casos súbitos de su Familia, deberán en diálogo fraterno con su Hermana Sirviente, tomar otras decisiones. </p><p class="ql-align-justify">Tener presente este permiso en la planificación comunitaria.</p>`;
