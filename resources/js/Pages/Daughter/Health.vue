<template>
  <app-layout>
    ...
    <div class="my-2 md:m-2 lg:m-4 xl:m-5 md:p-2 lg:p-4 rounded-md bg-gray-50">
      <div>
        ...
        <div>
          ...
          <div class="mt-5 md:mt-0 md:col-span-2">
            <section
              class="bg-indigo-100 y-1 px-4 sm:p-6 md:py-10 md:px-8 rounded-lg sm:m-2 lg:m-3 md:m-4"
            >
              <div
              ...
              >
                ...
                >
                  <h1
                    class="mt-1 text-bold font-semibold text-black sm:text-black md:text-2xl dark:sm:text-white"
                  >
                    Provincia Ecuador
                  </h1>
                  <p
              ...
              <div class="mt-2">
                <p class="text-black dark:text-white">
                  ...
                  información el historial médico.
                </p>
              </div>
            </section>
      ...
      >
        <template #title> Actualizar los datos de Estado de Salud</template>
        <template #content>
          <label
          ...
          <small
            >Formato: Detallar los problemas de salud que presenta la hermana,
