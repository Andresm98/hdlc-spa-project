                ...
                <tr v-for="file in this.files_list.data" :key="file">
                  ...
                  >
                    <div class="mx-auto flex gap-10">
                      ...
                      <a
                        :href="
                          this.route('daughter.files.show', {
                            file_id: file.id,
                          })
                        "
                      >
...
export default {
  ...
  watch: {
    params: {
      handler: throttle(function () {
        ...
        this.$inertia.get(this.route("daughter.files.index"), params, {
          replace: true,
          preserveState: true,
          preserveScroll: true,
          onSuccess: () => {},
  ...
  methods: {
    ...
    confirmationFileUpdate(file) {
      ...
      axios
        .get(
          this.route("daughter.files.edit", {
            file_id: file.id,
          })
        )
        .then((response) => {
