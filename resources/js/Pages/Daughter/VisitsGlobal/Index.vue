<template>
  <app-layout>
    ...
    <operation></operation>
    <section
      class="bg-orange-100 dark:bg-slate-800 y-1 px-4 sm:p-6 md:py-10 md:px-8 pt-2 pb-4 rounded-lg sm:m-2 lg:m-3 md:m-4"
    >
      <div
                      ...
                      <template #dropdown>
                        ...
                        >
                          <a
                            ...
                            :href="
                              route(
                                'daughter.visits.communities.export.excel',
                                this.params
                              )
                            "
                            >Excel</a
                          ...
                          <a
                            ...
                            :href="
                              route(
                                'daughter.visits.communities.export.csv',
                                this.params
                              )
                            "
                            >CSV</a
  ...
  methods: {
    onSearchCommunityChange(search) {
      ...
      if (search != null) {
        axios
          .get(
            this.route("daughter.visits.communities.index", {
              search: search,
            })
          )
          .then((response) => {
