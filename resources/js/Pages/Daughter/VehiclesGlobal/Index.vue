<template>
  <app-layout>
    ...
    <operation></operation>
    <section
      class="bg-sky-200 dark:bg-slate-800 y-1 px-4 sm:p-6 md:py-10 md:px-8 pt-2 pb-4 rounded-lg sm:m-2 lg:m-3 md:m-4"
    >
      <div
      ...
      <div class="mt-2">
        <p class="text-black dark:text-white">
          ...
          vehículos que pertenecen a su Comunidad u Obra.
        </p>
      </div>
