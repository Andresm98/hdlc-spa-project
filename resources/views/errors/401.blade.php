...
<body>
    <div class="scene">
        ...
        <div class="overlay"></div>
        <div class="overlay"></div>
        <span class="bg-401">401</span>
        <div class="text">
            <span class="hero-text"></span>
            <span class="msg">No tienes acceso <span>a</span> esta página.</span>
            <span class="support">
...
<style>
    ...
    *:after {
    ...
    .overlay:nth-of-type(1):hover~.bg-401,
    .overlay:nth-of-type(1):focus~.bg-401 {
    ...
    .overlay:nth-of-type(2):hover~.bg-401,
    .overlay:nth-of-type(2):focus~.bg-401 {
    ...
    .overlay:nth-of-type(3):hover~.bg-401,
    .overlay:nth-of-type(3):focus~.bg-401 {
    ...
    .overlay:nth-of-type(4):hover~.bg-401,
    .overlay:nth-of-type(4):focus~.bg-401 {
