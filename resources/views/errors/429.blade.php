...
<body>
    <div class="scene">
        ...
        <div class="overlay"></div>
        <div class="overlay"></div>
        <span class="bg-403">429</span>
        <div class="text">
            <span class="hero-text"></span>
            <span class="msg">Excesivas solicitudes realizadas  <span>al</span> servidor</span>
            <span class="support">
    ...
    *:after {
    ...
    .lock {
        box-shadow: 32px 8px 0 0 #e4e4e4, 40px 8px 0 0 #e4e4e4, 48px 8px 0 0 #e4e4e4,
            ...
            72px 48px 0 0 #909090, 8px 56px 0 0 #fb7d79, 16px 56px 0 0 #fb7d79,
            24px 56px 0 0 #fb7d79, 32px 56px 0 0 #fb7d79, 40px 56px 0 0 #fb7d79,
            48px 56px 0 0 #fb7d79, 56px 56px 0 0 #fb7d79, 64px 56px 0 0 #fb7d79,
            72px 56px 0 0 #fb7d79, 80px 56px 0 0 #fb7d79, 8px 64px 0 0 #ffc107,
