...
<head>
    ...
    <head>
        <meta charset="UTF-8">
        <title>Reporte Obra Individual {{ $data->get('community')->comm_name }}</title>
...
<body>
        ...
        <div style=" margin-block-start: 0.2cm; color: #000000">
            <div>
                <div style="float: left;width: 90%; height: 30px;">
                    ...
                    <p>Reporte de la Obra Individual</p>
                    </p>
                </div>
    ...
    <main>
        ...
        <div class="">
            ...
            <ul>
                {{-- User --}}
                <li style="margin-top:10px; font-size: small;"><strong>Nombre Obra Individual:</strong>
        ...
        <div style="font-size: small;">
            @if (null !== $data->get('daughters'))
                @if (count($data->get('daughters')) != 0)
                    ...
                    encuentran
                    todas las hermanas que están en la obra individual. Tenga en cuenta que se muestran los detalles de
                    cada
            ...
            @if (null !== $data->get('activities'))
                @if (count($data->get('activities')) != 0)
                    ...
                    todas las actividades que se han realizado en la obra individual en el presente año.
                    <br>
                    <br>
                    <div id="activities">
            ...
            @if (null !== $data->get('resumes'))
                @if (count($data->get('resumes')) != 0)
                    ...
                    el resumen anual de todo aquello que se ha realizado en la obra individual a lo largo del presente
                    año.
                    <br>
                    <br>
                    <div id="resumes">
            ...
            @if (null !== $data->get('visits'))
                @if (count($data->get('visits')) != 0)
                    ...
                    la lista de las visitas que se han realizado a la obra individual a lo largo del año.
                    <br>
                    <br>
                    <div id="visits">
            ...
            @if (null !== $data->get('inventory'))
                ...
                @if (null !== $data->get('sections'))
                    @if (count($data->get('sections')) != 0)
                        ...
                        encuentra la lista de secciones pertenecientes al inventario de la obra individual.
                        <br>
                        <br>
                        <div id="sections">
