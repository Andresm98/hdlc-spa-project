...
class WorkIndividualController extends Controller
{
    ...
    public function edit($slug)
    {
        ...
        return Inertia::render('Secretary/Communities/WorkIndividual/Edit', compact('community_custom', 'provinces', 'prefix', 'postfix'));
    }
    ...
    public function reportCommPDF(Request $request)
    {
        ...
        if ($community) {
            ...
            // return $data;
            //
            $pdf = PDF::loadView('reports.worksindividual.report', compact('data'));
